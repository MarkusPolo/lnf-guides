...
faqSections:
  - id: "gamedetails"
    headline: "Light No Fire Game Details – FAQ"
    items:
      - q: "What are the confirmed game details of Light No Fire?"
        a: "Confirmed systems include one Earth-sized shared planet, survival and exploration mechanics, persistent settlements, mounts and flying creatures, and now confirmed ocean crossings with large boats and crews. These details are backed by Hello Games’ official site, Steam page, and 2025 press coverage."
      - q: "What new game details were revealed in 2025?"
        a: "The key new element for 2025 is the confirmation of real oceans requiring multi-person boats and naval logistics. This indicates that teamwork and resource planning are as important as combat."
      - q: "How do Light No Fire game details compare to No Man’s Sky?"
        a: "Unlike No Man’s Sky’s many planets, Light No Fire focuses on one continuous, Earth-scale world. Both games share technical systems, such as crew-capable vessels and environmental simulation, but Light No Fire emphasizes grounded survival and social logistics."
      - q: "Which platforms are confirmed by official game details?"
        a: "PC is confirmed via the Steam page. No console platforms have been officially listed yet, so players should watch storefront and ratings board updates for changes."
      - q: "Why focus on game details instead of rumors?"
        a: "Because Hello Games historically avoids speculation and only confirms features when they are close to functional. Tracking official game details avoids hype cycles and gives a clearer view of the actual systems players will experience."
---
